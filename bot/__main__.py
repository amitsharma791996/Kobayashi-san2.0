...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://t.me/joinchat/bivaO38sz5gwYjI9")
    buttons.buildbutton("DM", "https://t.me/BhokariBaba")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Kobayashi-san can mirror all your links to Google Drive!
